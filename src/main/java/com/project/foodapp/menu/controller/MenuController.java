package com.project.foodapp.menu.controller;
...
import com.project.foodapp.menu.services.MenuService;
...
public class MenuController {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<com.project.foodapp.response.Response<MenuDTO>> updateMenu(

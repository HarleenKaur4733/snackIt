...
import com.project.foodapp.auth_users.services.UserService;
import com.project.foodapp.cart.entity.Cart;
import com.project.foodapp.cart.entity.CartItem;
import com.project.foodapp.cart.repository.CartRepository;
import com.project.foodapp.cart.services.CartService;
...
import com.project.foodapp.order.repository.OrderItemRepository;
import com.project.foodapp.order.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Response<?> placeOrderFromCart() {
        ...
        return Response.builder()
                ...
                .message(
                        "Your order has been received! We've sent a secure payment link to your email. Please proceed for payment to confirm your order.")
                .build();
    ...
    private void sendOrderConfirmationEmail(User customer, OrderDTO orderDTO) {
        ...
        // create a Thymeleaf contex and set variables. import the context from
        // Thymeleaf
        ...
        String paymentLink = basePaymentLink + orderDTO.getId() + "&amount=" + orderDTO.getTotalAmount(); // Replace
                                                                                                          // "yourdomain.com"
        context.setVariable("paymentLink", paymentLink);

        // Process the Thymeleaf template to generate the HTML email body
        String emailBody = templateEngine.process("order-confirmation", context); // "order-confirmation" is the
                                                                                  // template name
